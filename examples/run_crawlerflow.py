...
crawl_requests = yaml_to_json(open("example-configs/requests/github-detail-urls.yml"))
spider_config = yaml_to_json(open("example-configs/spiders/default-spider.yml"))
github_default_extractor = yaml_to_json(open("example-configs/extractors/github-blog-detail.yml"))
